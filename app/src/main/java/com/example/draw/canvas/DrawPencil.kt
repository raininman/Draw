...
import com.example.draw.MainActivity.Companion.path
import com.example.draw.cons.Pencil
...
class DrawPencil @JvmOverloads constructor(
    ...
    private fun touchStart(x: Float, y: Float) {
        val p = Pencil(currentBrush, currentWidth ,path)
        dataPencil.add(p)
    ...
    override fun onDraw(canvas: Canvas) {
        for (p in dataPencil) {
            ...
            paintBrush.strokeWidth = p.strokeWidth
